...
impl Client {
    ...
    async fn broadcast_message(
        ...
        assert!(self.current_room_name.is_some(), "Client tried to cast a message when room was none");
                ...
                match msg {
                    Message::Text(text) => {
                        ...
                        if text.starts_with("/join ") {
                            ...
                            // Join the new room
                            current_client.join_room(&client_id, &room_name, &rooms).await;
                            ...
                            if current_client.has_joined_room(){
                                current_client.broadcast_message( &text, &rooms, &clients).await;
                            } else {
